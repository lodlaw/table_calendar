...
class CalendarStyle {
  ...
  /// The elevation of the calendar
  final double elevation;

  /// The secondary markers color
  final Color markersSecondaryColor;
  ...
  const CalendarStyle({
    ...
    this.markersSecondaryColor = const Color(0xFF263238), // Material blueGrey[900]
