...
class _TableCalendarState extends State<TableCalendar>
  ...
  Widget build(BuildContext context) {
    ...
    final extraContent = widget.extraContent;
    return Column(
          ...
          if (widget.selectionMode == SelectionMode.multiple)
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: widget.onTapCancelMultipleSelections as void
                        Function()?,
                    child: Padding(
  ...
  Widget _buildCellContent(DateTime date) {
    ...
    if (widget.selectedDates != null) {
      tIsSelected = widget.calendarController
          ._isSelectedDate(date, widget.selectedDates!);
    }
